                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <?php
                                    ...
                                    ?>
                                    <a href="user_post_delete.php?post_id=<?php echo $post_id?>" class="btn btn-danger" style="padding:12px 18px"><i
                        ...
                        <div class="card-body" style="padding-left:40px;">
                            ...
                            <div class="flex-grow-0 py-3 px-4 border-top" style="padding:0;">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    if($user_id==$ruser_id){
                                    ?>
                                    <a href="user_reply_delete.php?reply_id=<?php echo $reply_id?>" class="btn btn-danger" style="padding:12px 18px"><i
                                            class="fa fa-trash"></i></a>
                                    <?php
                                    }else{}
                                    ?>
